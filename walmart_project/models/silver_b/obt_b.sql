...
{% set configs =[
    ...
    {
        "table": "walmart_data.silver_t.orders_t",
        "columns":"""o.order_id,
                        o.store_id,
                        o.order_timestamp,
                        o.payment_method,
    ...
    {
        "table": "walmart_data.silver_t.customers_t",
    ...
    {
        "table": "walmart_data.silver_t.order_items_t",
    ...
    {
        "table": "walmart_data.silver_t.products_t",
    ...
    {
        "table": "walmart_data.silver_t.employees_t",
    ...
    {
        "table": "walmart_data.silver_t.stores_t",
